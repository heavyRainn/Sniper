...
# --- Риск / капитал ---
ACCOUNT_EQUITY_VIRTUAL = 20.0   # ориентировочный капитал (для рассчёта размера позиции)
...
MAX_QTY_PER_TRADE = 0.002       # жёсткий лимит размера позиции
